    ...
    <section className="w-full bg-white py-24 lg:py-32">
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <div className="text-center max-w-[720px] mx-auto mb-16 lg:mb-20">
          <p className="text-[#A53DFF] tracking-widest uppercase font-medium mb-4">
            — Process —
          </p>

          <h2 className="text-[32px] lg:text-[48px] font-bold text-[#132238] mb-6">
            My Development Process
          </h2>

          <p className="text-[16px] lg:text-[18px] text-[#697484] leading-7">
